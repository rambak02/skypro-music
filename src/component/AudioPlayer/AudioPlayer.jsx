...
import { StyledBar, StyledBarContent,StyledBarPlayer, StyledBarPlayerBlock, StyledBarPlayerProgress, StyledBarVolumeBlock, StyledBarVolumeContent, StyledButtonNext, StyledButtonNextSvg, StyledButtonPlay, StyledButtonPlaySvg, StyledButtonPrev,StyledButtonPrevSvg, StyledButtonRepeat, StyledButtonRepeatSvg, StyledButtonShuffle, StyledButtonShuffleSvg, StyledPlayTrack, StyledPlayTrackAlbum, StyledPlayTrackAlbumLink, StyledPlayTrackAuthor, StyledPlayTrackAuthorLink, StyledPlayTrackContainer, StyledPlayTrackImage, StyledPlayTrackLikeDis, StyledPlayTrackSvg, StyledPlayerControls, StyledTrackDislike, StyledTrackDislikeSvg, StyledTrackLike, StyledTrackLikeSvg, StyledVolumeImage, StyledVolumeProgress, StyledVolumeProgressLine, StyledVolumeSvg } from "./AudioPLayer.styled";
            ...
            <StyledPlayTrack>
                <StyledPlayTrackContainer>
                    ...
                    <StyledPlayTrackAuthor >
                        <StyledPlayTrackAuthorLink href="http://"> {title}</StyledPlayTrackAuthorLink>
                    </StyledPlayTrackAuthor>
                    <StyledPlayTrackAlbum >
                        <StyledPlayTrackAlbumLink href="http://">{author}</StyledPlayTrackAlbumLink>
                    </StyledPlayTrackAlbum>
                </StyledPlayTrackContainer>
